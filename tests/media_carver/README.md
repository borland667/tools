...
This folder contains CLI-mode coverage for `media_carver.py`, lightweight tests
for `media_classifier.py`, and format-heuristic unit tests for parser
hardening paths (PNG/GIF/MPEG-PS/ISOBMFF/EBML).
